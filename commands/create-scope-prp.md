---
description: Create PRP (Product Requirement Prompt) for a given scope adressing multiple Linear issues
---
...
2. **External Research at scale**
   ...
   - For critical documentation, create a Linear document and link it in the PRP comment
...
Use `~/.agents/resources/prp/templates/prp_base.md` as your template structure - it contains all necessary sections and formatting.
...
For critical external documentation, create Linear documents and link them in the PRP comment.
